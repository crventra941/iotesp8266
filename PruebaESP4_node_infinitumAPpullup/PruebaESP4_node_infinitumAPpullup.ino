...
//Configuracion Wi-Fi
const char wifissid[] = "domo";
const char wifipsk[] = "tel123456";
...
//Declaro el sensor de la puerta en modo de intrada el 14
const int LED_PIN4 = 14;//
int puertaEstado = digitalRead(LED_PIN4);
//
...
void loop() {
            ...
            int vol2 = -1;
            int vol3 = -1;
           int vol4 = -1; //Este incica la puerta
          ...
          //Aqui se coloca lo de la puerta
           
            else if(req.indexOf("/led/10")!=-1)
             vol4=1;
          ///------------------------------------
          ...
          //De lo contrario ninguno jejejejXDXDXDXD
            ...
            if (vol >= 0 ){
             ...
             }else  if (puertaEstado >=1) {
              s += "<h5>Se encuentra: </h5>";
              s += (vol4)?"<p>Habierta</p>":"<section>Cerrada</section>";
             }
...
// ······················· Fin del método principal
                ...
                void initHardWare()
                {
                  ...
                  //LA PUERTA 
                  pinMode(LED_PIN4,INPUT_PULLUP);//ENTRADA DE UNA CORRIENTE O UNA TIERRA
